...
- [x] **6.2.3** Despacho dinâmico (override de métodos)
...
- [x] **6.3.3** Sem variáveis duplicadas no mesmo escopo
...
- [x] **7.3** Criar 1 programa com erro sintático para nova gramática (`prog-erro-sintatico-v2.ling`)
- [x] **7.4** Testar todos com o compilador e validar saídas
...
- [x] **8.5** Entregar: compilador + 4 códigos de teste
